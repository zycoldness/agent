...
SOLUTION = '{"tool":"final_decision","arguments":{"label":"unsafe","rule_id":"R-1","confidence":1.0}}'


def test_plugin_registers_three_unique_orms_and_delegates_to_pure_core(monkeypatch) -> None:
    ...
    assert set(registry) == {"risk_format_v1", "risk_label_exact_v1", "risk_rule_exact_v1"}
